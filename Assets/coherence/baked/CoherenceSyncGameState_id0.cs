...
namespace Coherence.Generated
{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'GameState' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncGameState_id0 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncGameState_id0>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncGameState_id0] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
